...
public class ReclamosController_GetClaimByStatus_Tests
{
    ...
    public ReclamosController_GetClaimByStatus_Tests()
    {
    ...
    [Fact]
    public async Task GetClaimByStatus_ShouldReturnOk_WhenClaimExists()
    {
        // Arrange
        var claimDto = "9a2e844b-fc27-4b94-949b-9757a3557411";
        mediatorMock.Setup(m => m.Send(It.IsAny<GetTodosLosClaimPorStatusQuery>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync([claimPorId]);

        // Act
        var result = await controller.GetClaimsByStatus(claimDto);

        // Assert
        Assert.IsType<OkObjectResult>(result);
        var okResult = result as OkObjectResult;
        Assert.Equal((List<ClaimDto>)[claimPorId], okResult.Value);
    }

    [Fact]
    public async Task GetClaimByStatus_ShouldReturnInternalServerError_WhenExceptionOccurs()
    {
        // Arrange
        var claimDto = "9a2e844b-fc27-4b94-949b-9757a3557411";
    ...
    [Fact]
    public async Task GetClaimByStatus_ShouldReturnBadRequest_WhenInvalidInput()
    {
        // Arrange
        var claimDto = "id";
